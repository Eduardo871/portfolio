        ...
        <div className= {`navBar ${active} actResponsive`} >
            ...
            <div className="listTwo">
                <ul className="listTwoUl">
                    <li><a href="https://github.com/Eduardo871"><i class="fab fa-github"></i></a></li>
                    <li><a href="https://wa.me/91127992695"><i class="fab fa-whatsapp"></i></a></li>
                    <li><a href="https://www.linkedin.com/in/sebastianciare/"><i class="fab fa-linkedin-in"></i></a></li>
                </ul>
            </div>

            <h1 className="navName">Sebastián Ciare</h1>
           {
